...
/*
Descrição: Esta função, exibirá as opcões de edição dos clientes existentes.
Parâmetro:
Retorno: 
*/
...
/*
Descrição: Esta função, listará os clientes existentes.
Parâmetro:
